    ...
    return (
        <section className="py-25 px-4 md:px-10 lg:px-[230px] bg-[#F7F8FC] flex flex-col lg:flex-row items-center justify-between gap-15">
            ...
            <div className="relative flex flex-col items-start ml-3">
                ...
                <div className="bg-gray-50 rounded-xl shadow p-6 w-full max-w-[460px] h-[190px] md:h-[190px] sm:h-[160px] absolute left-10 top-28 opacity-50 z-0 flex flex-col justify-end">
                    <div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md relative z-10 mt-6">
                    ...
                    <div className="absolute -top-6 -left-4">
                        <Image src="/aboutUsBoyImage.png" alt="Mike Taylor" width={48} height={48} className="rounded-full border-2 border-white" />
                    </div>
